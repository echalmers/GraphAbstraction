...
for state in absgraph.get_lower_abstraction_nodes(56, num, 0):
...
#get highest abstraction layer
# Gr = absgraph.graphs[num]
# GrAdd = []

#get all board states contianed in each node on highest abstraction layer to group them up
# for node in Gr:
